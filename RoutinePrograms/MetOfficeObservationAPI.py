...
#Data page?
DP = "val/wxobs/all/xml/3344?res=hourly&key="
...
if RefRefresh == 1:
    ...
    SQL = "DELETE FROM WeatherDataTypeRef WHERE DataType = 'Observations'"
...
SQLStart = "INSERT INTO WeatherObservations\
                                        (\
                                        ObservationTime\
                                        ,ObservationCode\
                                        ,ObservationValue\
...
SQLDelStart = "DELETE FROM WeatherObservations Where ObservationTime = "
